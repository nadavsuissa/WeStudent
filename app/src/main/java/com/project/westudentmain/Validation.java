...
public class Validation {
    ...
    public boolean Register(EditText user_email, EditText user_password, EditText user_firstName, EditText user_lastName, EditText user_userName, EditText user_university, EditText user_dgree, String email, String password, String firstName, String userName, String university, String dgree, String lastName, Uri uri, Button btn_upload_photo) {
        if (email.isEmpty()) {
